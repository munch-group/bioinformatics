...
There is no test script for this assignment. For this assignment you need a data file that you can also get below. Your exam assignment will not need any data from input files. 
