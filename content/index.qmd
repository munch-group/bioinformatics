...
# Exam information {.unnumbered}

::: {.callout-important}

## Exam information

You can find information about the exam under Exam in the left sidebar.

For your convenience, here is the curriculum for the exam listed in one place:

- Lecture notes: Chapters 1-15, 16-26, 28-33
...
- [Understanding Bioinformatics](https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=145685&type=coursefile&fileId=UnderstandingBioinformatics.pdf) 127-141, 438-448, 117-127, 494-496 
...
- [Compendium of selections from Biological Sequence Analysis](https://brightspace.au.dk/d2l/common/dialogs/quickLink/quickLink.d2l?ou=145685&type=coursefile&fileId=BiologicalSequenceAnalysis.pdf) 192-197, 165-179, 192-202, 46-66
- [The Theory and Practice of Genome Sequence Assembly](https://www.annualreviews.org/doi/10.1146/annurev-genom-090314-050032) 

:::

**<- See "Exam info" in the Content side bar**
...
- Lecture notes: @sec-pairwisealignment
...
@sec-translationproject is a mandatory assignment. The deadline for handing it in (on Brightspace) is the night before your exercise class in week 43.
:::
...
@sec-hivproject is a mandatory assignment. The deadline for handing it in is the night before your exercise class in week 47.
:::
