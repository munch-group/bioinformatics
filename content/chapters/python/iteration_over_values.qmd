# Iterating values {#sec-iteration}
...
3. Then you write `in`.
4.  The,n you write the name of an *iterable* or an expression that reduces to one. In the above case, it was the list `[1, 5, 3, 7]`.
...
It is not only lists that are iterable. Strings are, too. Their '__iter__' method of a string tells it that it should serve one character at a time. Try this:
...
[Check the documentation](https://docs.python.org/3/library/stdtypes.html#range) once you have decided.
