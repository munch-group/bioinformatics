...
conda create -y -n BSF --platform osx-64 -c conda-forge -c anaconda -c schrodinger pymol-bundle pyqt
```
...
```{.txt filename="Terminal"}
conda create -y -n BSF -c conda-forge -c anaconda -c schrodinger pymol-bundle pyqt
```
