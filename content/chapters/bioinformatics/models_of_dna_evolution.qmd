...
Under the JC69 model, each nucleotide has an equal probability of mutating to any of the three other nucleotides. If we denote the substitution rate as α, then the rate matrix Q describing instantaneous rates of change is:
...
$$P_{ij}^{ts}(t) = \frac{1}{4} + \frac{1}{4}e^{-4\beta t} - \frac{1}{2}e^{-2(\alpha + \beta)t}$$ (transitions)
$$P_{ij}^{tv}(t) = \frac{1}{4} - \frac{1}{4}e^{-4\beta t}$$ (transversions)
