...
##### Reading:  
  ...
  - Chapter @sec-preface
  - Chapter @sec-before_you_begin
  - Chapter @sec-bsf
  - Chapter @sec-helloworld
  - Chapter @sec-values
  - Chapter @sec-precedence
  - Chapter @sec-coursetools
...
- Chapter @sec-datastructures
- Chapter @sec-recursion
- Chapter @sec-testing_your_code
...
- Chapter @sec-translationproject
